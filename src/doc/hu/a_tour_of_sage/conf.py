...
html_theme_options.update({
  'source_view_link': os.path.join(source_repository, 'blob/main/src/doc/hu/a_tour_of_sage', '{filename}'),
  'source_edit_link': os.path.join(source_repository, 'edit/main/src/doc/hu/a_tour_of_sage', '{filename}'),
})
