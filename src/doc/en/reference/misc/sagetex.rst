...
<http://passagemath.org/docs/latest/html/en/tutorial/sagetex.html#make-sagetex-known-to-tex>`_
section of the `Sage tutorial
<http://passagemath.org/docs/latest/html/en/tutorial/index.html>`_ (`this link
