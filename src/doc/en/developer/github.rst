...
.. code-block:: console
    ...
    $ gh repo set-default passagemath/passagemath
...
.. tab:: By HTTPS protocol
   ...
   .. code-block:: console
       ...
       $ git clone https://github.com/alice/passagemath.git
       Cloning into 'passagemath'...
...
.. tab:: By SSH protocol
   ...
   .. code-block:: console
       ...
       $ git clone git@github.com:alice/passagemath.git
       Cloning into 'sage'...
       remote: Enumerating objects: 914565, done.
       remote: Counting objects: 100% (2738/2738), done.
       remote: Compressing objects: 100% (855/855), done.
...
.. tab:: By HTTPS protocol
   ...
   .. code-block:: console
       ...
       $ git remote add origin https://github.com/alice/passagemath.git
       $ git remote -v
       origin  https://github.com/alice/passagemath.git (fetch)
       origin  https://github.com/alice/passagemath.git (push)
       $ git fetch origin
...
.. tab:: By SSH protocol
   ...
   .. code-block:: console
       ...
       $ git remote add origin git@github.com:alice/passagemath.git
       $ git remote -v
       origin  git@github.com:alice/passagemath.git (fetch)
       origin  git@github.com:alice/passagemath.git (push)
       $ git fetch origin
...
.. tab:: By HTTPS protocol
   ...
   .. code-block:: console
       ...
       $ git remote add passagemath https://github.com/passagemath/passagemath.git
       $ git remote -v
       origin  https://github.com/alice/passagemath.git (fetch)
       origin  https://github.com/alice/passagemath.git (push)
...
.. tab:: By SSH protocol
   ...
   .. code-block:: console
       ...
       $ git remote add passagemath git@github.com:passagemath/passagemath.git
       $ git remote -v
       origin  git@github.com:alice/passagemath.git (fetch)
       origin  git@github.com:alice/passagemath.git (push)
...
To prevent accidental pushes to ``passagemath`` (instead of ``origin``), you may want to disable it by running::
   ...
   .. code-block:: console
       ...
       $ git remote set-url --push passagemath DISABLE
...
.. tab:: By SSH protocol
   ...
   .. code-block:: console
       ...
       $ git remote add passagemath git@github.com:sagemath/sage.git
       $ git remote -v
       origin  git@github.com:alice/passagemath.git (fetch)
       origin  git@github.com:alice/passagemath.git (push)
