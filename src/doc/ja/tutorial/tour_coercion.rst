...
実装法に関するチュートリアルは `Sage thematic tutorial <http://passagemath.org/docs/latest/html/en/thematic_tutorials/coercion_and_categories.html>`_ にある．
...
以下の説明はかなり簡略化されているので，詳しい解説と実装情報についてはSageレファレンスマニュアルの型強制に関する節と `thematic tutorial <http://passagemath.org/docs/latest/html/en/thematic_tutorials/coercion_and_categories.html>`_ を参照されたい．
