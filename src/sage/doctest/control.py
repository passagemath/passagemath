            ...
            if "all" in options.optional:
                ...
                if 'optional' in options.optional:
                    ...
                    for pkg in list_packages('optional', local=True).values():
                        ...
                        if pkg.name in ['bliss', 'coxeter3', 'database_graphs', 'eclib', 'ecm', 'fricas', 'frobby', 'gfan', 'giac', 'jmol', 'latte_int', 'macaulay2', 'mcqd', 'meataxe', 'msolve', 'palp', 'plantri', 'qepcad', 'sirocco', 'sympow', 'tdlib', 'topcom']:
                            continue
