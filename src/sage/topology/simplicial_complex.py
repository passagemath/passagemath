...
class SimplicialComplex(Parent, GenericCellComplex):
    ...
    def bigraded_betti_numbers(self, base_ring=ZZ, verbose=False):
        ...
        EXAMPLES::
            ...
            sage: sorted(X.bigraded_betti_numbers(base_ring=QQ).items(), reverse=True)  # needs sage.modules
            [((0, 0), 1), ((-1, 6), 1), ((-1, 4), 2), ((-2, 8), 1), ((-2, 6), 1)]
            sage: sorted(Y.bigraded_betti_numbers(verbose=True).items(), reverse=True)  # needs sage.modules
        ...
        simple enough to create a function as such::
            ...
            ....:             print(f'{r:{width}}', end=' ')
            ....:         print()
            sage: print_table(X.bigraded_betti_numbers())                               # needs sage.modules
                0 -1 -2
             0  1  0  0
             1  0  0  0
             2  0  0  0
