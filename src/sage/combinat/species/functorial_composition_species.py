...
class FunctorialCompositionSpecies(GenericCombinatorialSpecies):
    def __init__(self, F, G, min=None, max=None, weight=None):
        ...
        EXAMPLES::
            ...
            True
            sage: G._check()  # False due to isomorphism types not being implemented    # needs sage.libs.pari sage.modules
            False
        """
        self._F = F
        self._G = G
    ...
    def _isotypes(self, structure_class, s):
        ...
        EXAMPLES::
            ...
            sage: G = species.SimpleGraphSpecies()
            sage: G.isotypes([1,2,3]).list()                                            # needs sage.libs.pari sage.modules
    ...
    def _cis(self, series_ring, base_ring):
        ...
        EXAMPLES::
            ...
            sage: G = species.SimpleGraphSpecies()
            sage: G.cycle_index_series()[0:5]                                           # needs sage.libs.pari sage.modules
            [p[],
             p[1],
             p[1, 1] + p[2],
