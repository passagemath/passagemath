    ...
    class ParentMethods:
        ...
        def plot_mv_polytope(self, mv_polytope, mark_endpoints=True,
            ...
            EXAMPLES::
                ...
                sage: B = crystals.infinity.MVPolytopes(['C',2])                        # needs sage.graphs
                sage: L = RootSystem(['C',2]).ambient_space()
                sage: p = B.highest_weight_vector().f_string([1,2,1,2])                 # needs sage.graphs
            ...
            This also works in 3 dimensions::
                ...
                sage: # needs sage.combinat sage.groups
                sage: B = crystals.infinity.MVPolytopes(['A',3])                        # needs sage.graphs
                sage: L = RootSystem(['A',3]).ambient_space()
                sage: p = B.highest_weight_vector().f_string([2,1,3,2])                 # needs sage.graphs
