...
cdef class MatrixArgs:
    ...
    def finalized(self):
        ...
        Check the handling of ``row_keys`` and ``column_keys``::

            sage: MatrixArgs(row_keys=[1, 2]).finalized()
            <MatrixArgs for Set of Morphisms
             from Free module generated by {1, 2} over Integer Ring
               to Free module generated by {1, 2} over Integer Ring
               in Category of finite dimensional modules with basis over Integer Ring;
             typ=ZERO; entries=None>
            sage: MatrixArgs(column_keys=[3, 4]).finalized()
            <MatrixArgs for Set of Morphisms
             from Free module generated by {3, 4} over Integer Ring
               to Free module generated by {3, 4} over Integer Ring
               in Category of finite dimensional modules with basis over Integer Ring;
             typ=ZERO; entries=None>
            sage: MatrixArgs(row_keys=[1, 2], ncols=3).finalized()
            <MatrixArgs for Set of Morphisms
             ...
             typ=ZERO; entries=None>
            sage: MatrixArgs(nrows=1, column_keys=[3, 4]).finalized()
            <MatrixArgs for Set of Morphisms
             from Free module generated by {3, 4} over Integer Ring
               ...
               in Category of finite dimensional modules with basis over
                  (Dedekind domains and euclidean domains and noetherian rings
                   and infinite enumerated sets and metric spaces);
             typ=ZERO; entries=None>
            sage: MatrixArgs(row_keys=[1, 2], column_keys=[3, 4]).finalized()
            <MatrixArgs for Set of Morphisms
             from Free module generated by {3, 4} over Integer Ring
               to Free module generated by {1, 2} over Integer Ring
               in Category of finite dimensional modules with basis over Integer Ring;
            ...
            ....:            column_keys=range(2), row_keys=range(5)).finalized()
            <MatrixArgs for Set of Morphisms
             from Free module generated by {0, 1} over Integer Ring
    ...
    cdef int finalize(self) except -1:
        ...
        if self.typ & MA_FLAG_ASSUME_SQUARE:
            if self.ncols == -1 and self.column_keys is None:
                ...
                elif self.row_keys is not None:
                    self.column_keys = self.row_keys
                elif self.typ == MA_ENTRIES_ZERO:
                ...
                elif self.column_keys is not None:
                    self.row_keys = self.column_keys
