...
def resolve_package(pkg_base: str):
    """
    ...
    # To Get package type (optional/standard/doc/experimental/…)
    pkg_type = None
    ...
    for system in systems:
        ...
        if sys_pkgs:
            ...
            try:
                ...
                print("{}No package needed.".format(rst_indent), file=out)
        else:
            print("{}No package needed.".format(rst_indent), file=out)
        print("", file=out)
...
def emit_for_package(pkg_base: str, fmt, out_dir: Optional[str]) -> None:
    ...
    def _emit_sections(out_stream):
        ...
        # To Configure behavior (will use Package(pkg_scripts))
        print("", file=out_stream)
