...
# SAGE_LOCAL/share/* --> sage_wheels/share/*
with InWheel(wheel, wheel):
    command = f'set -o pipefail; (cd {shlex.quote(SAGE_LOCAL)} && tar cf - --dereference share/meataxe) | (mkdir -p sage_wheels && cd sage_wheels && tar xvf -)'
