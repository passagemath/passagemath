...
with InWheel(wheel, wheel):
    command = f'set -o pipefail; (cd {shlex.quote(SAGE_LOCAL)} && tar cf - --dereference share/pari/galdata) | (mkdir -p sage_wheels && cd sage_wheels && tar xvf -)'
