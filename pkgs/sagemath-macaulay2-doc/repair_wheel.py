...
# SAGE_LOCAL/share/doc/Macaulay2/ --> sage_wheels/share/doc/Macaulay2/
with InWheel(wheel, wheel):
    command = f'set -o pipefail; (cd {shlex.quote(SAGE_LOCAL)} && tar cf - --dereference share/doc/Macaulay2) | (mkdir -p sage_wheels && cd sage_wheels && tar xvf -)'
