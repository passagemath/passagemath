...
with InWheel(wheel, wheel):
    for dir in GAP_ROOT_PATHS.split(';'):
        ...
        name = Path(dir).name
        command = f'set -o pipefail; (cd {shlex.quote(str(parent))} && tar cf - --exclude "*/transgrp/data" --exclude "*/ctbllib/data" --exclude "*/tomlib/data" --exclude "*/irredsol/data" --exclude "*/irredsol/fp" --exclude "*/factint/tables" --exclude "*/primgrp/data" --exclude "*/simpcomp/complexes" --exclude "*/smallgrp/id*" --exclude "*/smallgrp/small*" --exclude "*/unitlib/data" --exclude "*/smallsemi/data" --exclude "*/rcwa/data" --exclude "*/difsets/data" --exclude "*/yangbaxter/data" --exclude "*/agt/srglib" --exclude "*/semigroups" --exclude "*/*/doc*" --exclude "*/*/tutorial" --exclude "*/**/*.o" --exclude "*/digraphs/extern" --exclude "*/digraphs/gen" --exclude "*/grape/nauty*" --exclude "*/*/src" --exclude "*/*/www" --exclude "*/*/htm" {name}) | tar xvf -'
