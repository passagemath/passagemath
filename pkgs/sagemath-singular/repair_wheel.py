...
with InWheel(wheel, wheel):
    command = f'set -o pipefail; (cd {shlex.quote(SAGE_LOCAL)} && tar cf - --dereference bin/*Singular {{lib,libexec,share}}/singular share/factory) | (mkdir -p sage_wheels && cd sage_wheels && tar xvf -)'
