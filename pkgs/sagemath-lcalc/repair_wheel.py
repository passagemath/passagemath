...
# SAGE_LOCAL/bin/lcalc --> sage_wheels/bin/lcalc
with InWheel(wheel, wheel):
    command = f'set -o pipefail; (cd {shlex.quote(SAGE_LOCAL)} && tar cf - --dereference bin/lcalc) | (mkdir -p sage_wheels && cd sage_wheels && tar xvf -)'
