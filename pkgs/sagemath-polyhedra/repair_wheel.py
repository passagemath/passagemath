...
# SAGE_LOCAL/share/reflexive_polytopes/** --> sage_wheels/share/reflexive_polytopes/**
with InWheel(wheel, wheel):
    command = f'set -o pipefail; (cd {shlex.quote(SAGE_LOCAL)} && tar cf - --dereference share/reflexive_polytopes) | (mkdir -p sage_wheels && cd sage_wheels && tar xvf -)'
