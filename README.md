...
| [![PyPI: passagemath-highs](https://img.shields.io/pypi/v/passagemath-highs.svg?label=passagemath-highs)](https://pypi.python.org/pypi/passagemath-highs) provides a mixed-integer linear programming backend using [HiGHS](https://www.highs.dev). ‹Linux·macOS·WSL··MSYS2·Wasm› |
