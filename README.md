...
| [![PyPI: passagemath-gsl](https://img.shields.io/pypi/v/passagemath-gsl.svg?label=passagemath-gsl)](https://pypi.python.org/pypi/passagemath-gsl) provides numerical methods using the GNU Scientific Library. ‹Linux·macOS·WSL› |
...
| [![PyPI: passagemath-highs](https://img.shields.io/pypi/v/passagemath-highs.svg?label=passagemath-highs)](https://pypi.python.org/pypi/passagemath-highs) provides a mixed-integer linear programming backend using HiGHS. ‹Linux·macOS·WSL› |
