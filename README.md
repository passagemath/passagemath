...
| [![PyPI: passagemath-ecl](https://img.shields.io/pypi/v/passagemath-ecl.svg?label=passagemath-ecl)](https://pypi.python.org/pypi/passagemath-ecl) provides the functionality of Embeddable Common Lisp. ‹Linux·macOS·WSL···› |
